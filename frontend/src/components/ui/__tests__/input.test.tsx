...
describe('Input Component', () => {
  it('renders input correctly with default props', () => {
    ...
    // Don't check for type attribute if it's not explicitly set in the component
  });
  ...
  it('applies focus-visible styles on focus', async () => {
    ...
    // Note: Can't directly test pseudo-classes in JSDOM, but we can verify they're in the className
  });
});
